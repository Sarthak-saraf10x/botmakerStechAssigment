    ...
    <section className="relative z-10 py-24 bg-[#0c0b0b] border-t border-b border-[#2e2e2e]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-6 space-y-6 text-left">
          ...
          <h2 className="text-4xl font-extrabold text-white">THE CHAMPIONSHIP STAGE</h2>
          ...
          <div className="pt-4 border-t border-[#2e2e2e] flex items-center justify-between">
            <div className="text-left">
              <span className="block text-2xl font-black text-[#ff4c4c]">40m x 20m</span>
              <span className="text-[10px] uppercase text-gray-500 font-bold">TOTAL ARENA SIZE</span>
            </div>
            <div className="text-left">
              <span className="block text-2xl font-black text-[#ffc702]">12 Sensors</span>
              <span className="text-[10px] uppercase text-gray-500 font-bold">TELEMETRY ANCHORS</span>
            </div>
            <div className="text-left">
              <span className="block text-2xl font-black text-green-500">60 FPS</span>
              <span className="text-[10px] uppercase text-gray-500 font-bold">TRACKING LATENCY</span>
            </div>
          </div>
        </div>
